...
def add_PCR_errors(df_amplicons,genome_abundances,PRIMER_BED,WUHAN_REF,AMPLICONS_FOLDER,U_SUBS_RATE,U_INS_RATE,U_DEL_RATE,
    ...
    R_VAF=dict(SUBS=R_SUBS_VAF_DIRICHLET_PARAMETER,INS=R_INS_VAF_DIRICHLET_PARAMETER,DEL=R_DEL_VAF_DIRICHLET_PARAMETER)
        ...
        if mut_indices==[]:
            ...
            if df.CIGAR[0]=="*":
                ...
                if reads_df.empty:
                    ...
                    seq_pos_df=seq_pos_df[seq_pos_df['seq_pos']!=ISSUE_6_BUG_CODE]#skip errors that correspond to deletions (issue #6)
